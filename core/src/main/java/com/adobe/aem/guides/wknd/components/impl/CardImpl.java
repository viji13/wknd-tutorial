...
public class CardImpl implements Card {
    ...
    //Relative location of Article Page to look for Hero Image
  	private static final String HERO_IMAGE_LOCATION = "root/responsivegrid/image";
	...
	public String getTitle() {
		...
		if (articlePage != null) {
			articleTitle = StringUtils.isNotBlank(articlePage.getTitle()) ? articlePage.getTitle() : articlePage.getName();
		}
		return title;
	}
